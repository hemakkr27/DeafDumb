...
import 'Number.dart';
import 'Vegatable/vegatable.dart';
import 'animals/home.dart';
import 'mapapi.dart';

class Homecls extends StatefulWidget {
  const Homecls({Key? key}) : super(key: key);

  @override
  _HomeclsState createState() => _HomeclsState();
}

class _HomeclsState extends State<Homecls> {
  @override
            ...
            GridView.count(
              ...
              children: [
                Custumcls(
                    ...
                    s1: "ABC Alphabets",
                    //s2: "Texy",
                    icon: Icon(Icons.ac_unit, size: 25, color: Colors.blue)),
                Custumcls(
                    w1: BasicSign(),
                    s1: "Basic Sign ",
                    icon: Icon(Icons.ac_unit, size: 25, color: Colors.blue)),
